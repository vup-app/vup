// ! Source Code from https://github.com/bitsdojo/bitsdojo_window (MIT license)
...
const titleBarButtonSize = Size(46, 32);
const borderSize = 0.0;
    ...
    return MouseStateBuilder(
      builder: (context, mouseState) {
        ...
        double defaultPadding =
            (titleBarHeight - borderSize) / 3 - (borderSize / 2);
...
class MaximizeWindowButton extends WindowButton {
  MaximizeWindowButton(
      ...
      : super(
            ...
            onPressed: onPressed ?? () => maximizeOrRestore());
}
